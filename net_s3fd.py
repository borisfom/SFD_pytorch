...
class L2Norm(nn.Module):
    def __init__(self,n_channels, scale=1.0, fp16=False):
...
class s3fd(nn.Module):
    def __init__(self, fp16=False):
        ...
        self.conv3_3_norm = L2Norm(256,scale=10, fp16=fp16)
        self.conv4_3_norm = L2Norm(512,scale=8, fp16=fp16)
        self.conv5_3_norm = L2Norm(512,scale=5, fp16=fp16)
